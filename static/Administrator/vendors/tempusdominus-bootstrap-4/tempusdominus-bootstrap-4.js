...
var TempusDominusBootstrap4 = function ($) {
  ...
  var TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
    ...
    _proto2._getDatePickerTemplate = function _getDatePickerTemplate() {
      var headTemplate = $('<thead>').append($('<tr>').append($('<th style="color: black;">').addClass('prev').attr('data-action', 'previous').append(this._iconTag(this._options.icons.previous))).append($('<th style="color: black;">').addClass('picker-switch').attr('data-action', 'pickerSwitch').attr('colspan', "" + (this._options.calendarWeeks ? '6' : '5'))).append($('<th style="color: black;">').addClass('next').attr('data-action', 'next').append(this._iconTag(this._options.icons.next)))),
    ...
    _proto2._fillDow = function _fillDow() {
      ...
      if (this._options.calendarWeeks === true) {
        row.append($('<th style="color: black;">').addClass('cw').text('#'));
      }

      while (currentDate.isBefore(this._viewDate.clone().endOf('w'))) {
        row.append($('<th style="color: black;">').addClass('dow').text(currentDate.format('dd')));
        currentDate.add(1, 'd');
      }
